	...
	return (
		<div style={{
			...
			<p style={{ textAlign: 'left', marginBottom: '0' }}>
				Das Passwort muss zwischen <span style={{ color: color }}>8 und 128 Zeichen</span><br/> lang sein.
				Erlaubt sind<br/>
				<span style={{ color: color }}>Kleinbuchstaben, Großuchstaben, Zahlen<br/>und diese Zeichen: </span>
