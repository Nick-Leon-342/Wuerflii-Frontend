...
export default function DialogPassword() {
	...
	return (
		...
		>
			...
			Das Passwort muss zwischen <span style={{ color: color }}>8 und 128 Zeichen</span> lang sein.<br/><br/>
			Erlaubt sind:<br/>
			<span style={{ color: color }}>Kleinbuchstaben, Großuchstaben, Zahlen und diese Zeichen:</span>
